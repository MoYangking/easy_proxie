...
// FetchNodesFromSubscription fetches and parses nodes from a subscription URL.
func FetchNodesFromSubscription(subURL string, timeout time.Duration) ([]NodeConfig, error) {
	return loadNodesFromSubscription(subURL, timeout)
}
