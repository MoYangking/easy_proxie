...
services:
  easy-proxies:
    ...
    volumes:
      ...
      - ./nodes.txt:/data/easy-proxies/nodes.txt
```
...
> **Tip**: If the config path directory or file doesn't exist, easy-proxies will auto-create the directory and generate a default `config.yaml` on startup.
